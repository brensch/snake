	...
	tests = []testCase{
		{
			...
			state:       []byte(`{"Turn":0,"Height":11,"Width":11,"Food":[{"X":0,"Y":8},{"X":6,"Y":10},{"X":5,"Y":5}],"Snakes":[{"ID":"you","Body":[{"X":1,"Y":10},{"X":1,"Y":9},{"X":1,"Y":8},{"X":1,"Y":7}],"Health":100,"EliminatedCause":"","EliminatedOnTurn":0,"EliminatedBy":""},{"ID":"not_you","Body":[{"X":3,"Y":7},{"X":3,"Y":8},{"X":3,"Y":9},{"X":2,"Y":9},{"X":2,"Y":8}],"Health":100,"EliminatedCause":"","EliminatedOnTurn":0,"EliminatedBy":""}],"Hazards":null}`),
			scoreMin:    0.66,
			scoreMax:    0.67,
		},
	}
...
func TestAllMovesForSnake(t *testing.T) {
...
func BenchmarkAllMovesForSnake(b *testing.B) {
	log.SetLevel(log.DebugLevel)
	...
	for n := 0; n < b.N; n++ {
		...
		AllMovesForSnake(s, 0)

	}
}

func BenchmarkAllMovesForSnakeSlow(b *testing.B) {
	log.SetLevel(log.DebugLevel)
