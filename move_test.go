...
var (
	tests = []testCase{
		...
		// 	okMoves:     []rules.Direction{rules.DirectionLeft},
		// },
		{
		...
		// 	okMoves:     []rules.Direction{rules.DirectionUp},
		// },
		// {
		...
		// 	okMoves:     []rules.Direction{rules.DirectionRight, rules.DirectionUp},
		// },
		{
		...
		},
		{
			...
			okMoves:     []rules.Direction{rules.DirectionDown, rules.DirectionLeft},
		},
		{
		...
		},
		{
			...
			okMoves:     []rules.Direction{rules.DirectionRight, rules.DirectionDown},
		},
		{
		...
		},
		{
			...
			okMoves:     []rules.Direction{rules.DirectionLeft, rules.DirectionRight},
		},
		{
		...
		// https://play.battlesnake.com/g/c5abc16a-8970-4fd4-abb8-0439c00d8ddd/
		// turn 130

		// https://play.battlesnake.com/g/70d6e123-9f50-4337-b0cb-e99f5ec67335/
		// turn 196
	}
)
